-- Content schema for portfolio with public read access and dynamic column introspection
...
create policy if not exists "Public read skill_categories" on public.skill_categories for select using (true);
create policy if not exists "Public read skills" on public.skills for select using (true);
create policy if not exists "Public read skill_category_skills" on public.skill_category_skills for select using (true);
create policy if not exists "Public read projects" on public.projects for select using (true);

-- 7) Realtime-ready (optional, harmless if not used)
